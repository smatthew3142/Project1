...
//get YouTube videos -Sarika
  ...
  //clear form for next search
   ...
   //FIREBASE ELEMENT//- SARIKA
    ...
    database.ref().orderByChild("dateAdded").limitToLast(5).on("child_added", function(childSnapshot, prevChildKey){
    ...
    $("#user-table > tbody").prepend("<tr><td>" + userName + "</td><td>" + userFood + "</td><td>" +
